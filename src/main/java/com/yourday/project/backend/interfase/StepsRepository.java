...
public interface StepsRepository extends JpaRepository<Steps, String>
{
    ...
    List<Steps> findTotalStepsByUserIdAndUsageDateBetween(String user, LocalDate usageDate, LocalDate usageDate2);

    Steps findTotalStepsByUserIdAndUsageDate (String user, LocalDate usageDate);
}
